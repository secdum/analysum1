 ...
 * library.  */
#define GPGME_VERSION "2.0.1"

/* The version number of this header.  It may be used to handle minor
 * API incompatibilities.  */
#define GPGME_VERSION_NUMBER 0x020001
...
/* A key has one or more subkeys.  The first subkey is the OpenPGP
 * primary key. */
struct _gpgme_subkey;
typedef struct _gpgme_subkey *gpgme_subkey_t;

/* A key has one or more user-ids.  */
struct _gpgme_user_id;
typedef struct _gpgme_user_id *gpgme_user_id_t;

/* Each user-id and each subkey has at least one key signature.  */
struct _gpgme_key_sig;
typedef struct _gpgme_key_sig *gpgme_key_sig_t;

/* An object to hold information about notation data.  */
struct _gpgme_sig_notation;
typedef struct _gpgme_sig_notation *gpgme_sig_notation_t;

/* An object to hold TOFU information. */
struct _gpgme_tofu_info;
typedef struct _gpgme_tofu_info *gpgme_tofu_info_t;

/* An object for a designated revocation key.  */
struct _gpgme_revocation_key;
typedef struct _gpgme_revocation_key *gpgme_revocation_key_t;

/* A result object for an invalid key.  */
struct _gpgme_invalid_key;
typedef struct _gpgme_invalid_key *gpgme_invalid_key_t;

/* Object describing properties of an engine.  */
